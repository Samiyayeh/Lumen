...
- **Summary:** Wang et al. address the challenge of identifying contextual energy waste across time-varying building profiles by formulating a two-level detection framework that contextualizes operational time-series data and applies localized outlier algorithms to isolate irregular electrical consumption.
