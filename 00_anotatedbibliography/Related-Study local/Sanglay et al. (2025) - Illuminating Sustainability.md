...
- **Relevance:** The study confirms that room-level load profiling in Philippine universities identifies persistent lighting inefficiencies amounting to 1,252.14 kWh in monthly avoidable consumption, providing empirical justification for deploying localized sub-panel monitoring in the proposed system to isolate off-hours lighting and idle equipment waste.

- **Source Reference(s):**
  - *Section 1 (Introduction) & Section 2 (Methodology):* Energy audit and lux measurement methodology deployed across academic buildings and administrative offices at Quirino State University Cabarroguis Campus.
  - *Section 3 (Results and Discussion):* Quantitative consumption analysis establishing estimated avoidable baseline consumption of 1,252.14 kWh per month through targeted efficiency measures.
