...
- **Entry Linking:** Place the category link at the top of the new note:
  ...
  **Category:** [[<Category Hub Name>]]
  ...
  - **Category Hub Linking:** Append the new note's wikilink `[[<Note Name>]]` to the corresponding category hub note (e.g., `Related Study local.md`), which connects to `[[Bibliography]]`. (add every entry a check box)
